...
if(isset($_POST['addProduct']))
{
    ...
    $product_image_folder = 'image/'.$product_image;
        ...
        if(empty($product_name) || empty($product_price) || empty($product_description) || empty($product_image))  {
            ...
            $insertProduct = $bdd->prepare('INSERT INTO product(product_name,  product_price, product_description, product_image) VALUES(? ,? ,?, ?)');
            $insertProduct->execute(array($product_name, $product_price,$product_description,$product_image));
